...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "status", sa.String(length=16), server_default=sa.text("'active'::character varying"), nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status", sa.String(length=255), server_default=sa.text("'normal'::character varying"), nullable=False
        ),
    ...
    op.create_table(
        "celery_taskmeta",
        sa.Column("id", sa.Integer(), nullable=False, server_default=sa.text("nextval('task_id_sequence')")),
    ...
    op.create_table(
        "celery_tasksetmeta",
        sa.Column("id", sa.Integer(), nullable=False, server_default=sa.text("nextval('taskset_id_sequence')")),
    ...
    op.create_table(
        ...
        sa.Column("dataset_id", postgresql.UUID(), nullable=False),
        sa.Column(
            "mode", sa.String(length=255), server_default=sa.text("'automatic'::character varying"), nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "provider", sa.String(length=255), server_default=sa.text("'vendor'::character varying"), nullable=False
        ),
        sa.Column(
            "permission", sa.String(length=255), server_default=sa.text("'only_me'::character varying"), nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status", sa.String(length=255), server_default=sa.text("'waiting'::character varying"), nullable=False
        ),
        sa.Column("created_by", postgresql.UUID(), nullable=False),
        sa.Column("created_at", sa.DateTime(), server_default=sa.text("CURRENT_TIMESTAMP(0)"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            "status", sa.String(length=16), server_default=sa.text("'unused'::character varying"), nullable=False
        ),
    ...
    with op.batch_alter_table("pinned_conversations", schema=None) as batch_op:
        batch_op.create_index(
            "pinned_conversation_conversation_idx", ["app_id", "conversation_id", "created_by"], unique=False
        )
    ...
    op.create_table(
        ...
        sa.Column(
            "provider_type", sa.String(length=40), nullable=False, server_default=sa.text("'custom'::character varying")
        ),
