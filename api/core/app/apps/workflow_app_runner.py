        ...
        if isinstance(event, GraphRunStartedEvent):
            ...
            self._publish_event(
                QueueNodeSucceededEvent(
                    ...
                    start_at=event.route_node_state.start_at,
                    inputs=(
                        event.route_node_state.node_run_result.inputs if event.route_node_state.node_run_result else {}
                    ),
                    process_data=(
                        event.route_node_state.node_run_result.process_data
                        if event.route_node_state.node_run_result
                        else {}
                    ),
                    outputs=(
                        event.route_node_state.node_run_result.outputs if event.route_node_state.node_run_result else {}
                    ),
                    execution_metadata=(
            ...
            self._publish_event(
                QueueNodeFailedEvent(
                    ...
                    error=(
                        event.route_node_state.node_run_result.error
