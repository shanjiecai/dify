    ...
    def load(self) -> list[Document]:
        ...
        if self._upload_file:
            if self._upload_file.hash:
                plaintext_file_key = (
                    "upload_files/" + self._upload_file.tenant_id + "/" + self._upload_file.hash + ".0625.plaintext"
                )
                try:
                    ...
                    pass
        if (
            "table" in self._file_path.lower()
            or "form" in self._file_path.lower()
            or "chart" in self._file_path.lower()
            ...
            if tables:
                ...
                for index, t in enumerate(tables):
                    ...
                    documents.append(Document(page_content=_str, metadata={"source": self._file_path, "page": index}))
        else:
