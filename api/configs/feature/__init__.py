...
class HttpConfig(BaseSettings):
    ...
    inner_APP_API_CORS_ALLOW_ORIGINS: Optional[str] = Field(
        description='',
        validation_alias=AliasChoices('APP_API_CORS_ALLOW_ORIGINS'),
        default='*',
    )

    @computed_field
    @property
    def APP_API_CORS_ALLOW_ORIGINS(self) -> list[str]:
        return self.inner_APP_API_CORS_ALLOW_ORIGINS.split(',')
