...
class ConversationPlanDetail(db.Model):
    ...
    tag_list = db.Column(JSONB, nullable=True)
    image_list = db.Column(JSONB, nullable=True)
    img_perfect_prompt_list = db.Column(JSONB, nullable=True)
...
class Message(db.Model):
    ...
    assistant_name = db.Column(db.String(255), nullable=True)
